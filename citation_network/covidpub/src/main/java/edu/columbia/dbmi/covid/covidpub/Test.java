...
public class Test {
	...
	public static void main(String[] args) {
		...
		StringBuffer paper_metadata = new StringBuffer();
		StringBuffer ref_pos=new StringBuffer();
		File dir = new File("/Users/cy2465/Downloads/pubmed_ref_project/custom_license/pdf_json");
		...
		for (File f : dir.listFiles()) {
			...
			paper_metadata.append(paper_id + "\t" + paper_title + "\t" + pfirst_au_firstname + "\t"
					+ pfirst_au_lastname + "\t" + plast_au_firstname + "\t" + plast_au_lastname+"\n");
			/**
			 * Text
			 * 
			 */
			...
			for (int j = 0; j < body_textja.size(); j++) {
				...
				for (int k = 0; k < cite_spans_ja.size(); k++) {
					...
					if(citejo.containsKey("mention")){
					 mention = citejo.get("mention").toString();
					}
			...
			//if(fcount%5000==0){
			//	FileUtil.write2File("/Users/cy2465/Downloads/pubmed_ref_project/custom_license/pdf_json_metadata"+fcount+".txt",
			//			paper_metadata.toString());
			//	paper_metadata.setLength(0);
			//}
			
		}
		FileUtil.write2File("/Users/cy2465/Downloads/pubmed_ref_project/custom_license/pdf_json_metadata_"+fcount+".txt",
				paper_metadata.toString());
		FileUtil.write2File("/Users/cy2465/Downloads/pubmed_ref_project/custom_license/pdf_json_combined.txt",
				paper_ref.toString());
